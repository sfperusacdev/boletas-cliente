  ...
  return (
    <header className="fixed w-full bg-white/90 dark:bg-black/80 backdrop-blur-sm z-50 shadow-sm">
      <nav className="relative max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <button onClick={() => setMenuOpen(!menuOpen)} className="md:hidden cursor-pointer z-50">
          <svg
        ...
        >
          <a href="#inicio" className="block w-full md:w-auto text-black dark:text-white">
            Inicio
          </a>
          <a href="#soluciones" className="block w-full md:w-auto text-black dark:text-white">
            Solución
          </a>
          <a href="#beneficios" className="block w-full md:w-auto text-black dark:text-white">
            Beneficios
          </a>
          <a href="#precios" className="block w-full md:w-auto text-black dark:text-white">
            Precios
          </a>
          <a
