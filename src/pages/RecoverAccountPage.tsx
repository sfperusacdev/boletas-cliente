...
export const RecoverAccountPage = () => {
  ...
  const mutation = useMutation({
    ...
    onError: () => toast.error("Hubo un problema al enviar el correo con las instrucciones. Intenta nuevamente"),
        ...
        <div className="w-full max-w-sm bg-base-100 border border-base-300 shadow-xl rounded-xl p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="text-base-content/70 text-sm mt-1">
              Se envió un correo con las instrucciones a <span className="font-bold">{mutation.data?.["email"]}</span>
            </p>
          </div>
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-base-200 px-4">
      <div className="w-full max-w-sm bg-base-100 border border-base-300 shadow-xl rounded-xl p-8 space-y-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold">Recuperar cuenta</h2>
          <p className="text-base-content/70 text-sm mt-1">Ingresa tu DNI para recuperar tu cuenta</p>
        </div>
